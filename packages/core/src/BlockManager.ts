import type { BlockModel, BlockManagerOptions } from './types';
...
export class BlockManager {
    ...
    private registeredBlocks: Record<string, BlockModel> = {}

    constructor(initialBlocks: BlockModel[] = [], options: BlockManagerOptions = {}) {
    ...
    registerBlock(block: BlockModel): BlockModel {
    ...
    addBlock(type: string, props?: Record<string, unknown>): BlockModel {
    ...
    editBlock(index: number, props: Record<string, unknown>): BlockModel {
