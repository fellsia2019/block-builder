...
Показывает, как пользователь должен использовать пакет в реальном проекте.
...
3. **Откройте примеры:**
   - `http://localhost:3000/examples/user-app/` - Пользовательское приложение
   - `http://localhost:3000/examples/package-demo/` - Демо пакета
